...
namespace DIM {
  ...
  void TheChained::initializeSpecific() {
    ...
    std::cout << "nunca nem vi mee" << std::endl;
  ...
  TheChainedMemento TheChained::createMemento() const {
    TheChainedMemento memento(time);
    return memento;
  }

  void TheChained::loadMemento(TheChainedMemento memento) {
