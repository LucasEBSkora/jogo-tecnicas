...
namespace DIM {
  namespace Managers {
    ...
    bool CollisionManager::colliding(Entities::PhysicalEntity* e1, Entities::PhysicalEntity* e2) {
      Utility::VectorF pos1 = e1->getPos();
      Utility::VectorF pos2 = e2->getPos();
      Utility::VectorF size1 = e1->getSize();
      Utility::VectorF size2 = e2->getSize();

      Utility::VectorF c1 = pos1 + size1 * .5;
      Utility::VectorF c2 = pos2 + size2 * .5;
