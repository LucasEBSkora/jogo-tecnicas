...
namespace FISW {
  ...
  class Element {
    ...
    public:
      ...
      //Retorna a lista de caminhos para os assets que esse elemento precisa. Pode retornar uma lista vazia, ou simplesmente retornar a lista dos elementos agregados
      ...
      //Seria a função que atualizaria as coisas, mas dependendo do modelo de tratamento de eventos pode se tornar desnecessária (o desejado)
